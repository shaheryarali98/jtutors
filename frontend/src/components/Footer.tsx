  ...
  return (
    <footer className="relative overflow-hidden py-16 mt-16">
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        <div className="rounded-3xl bg-white/10 p-10 text-white shadow-2xl backdrop-blur">
        ...
        <p className="mt-6 text-center text-sm font-medium text-white/85">
          Email us at{' '}
          <a href="mailto:info@jtutors.com" className="underline decoration-white/40 underline-offset-4 transition hover:text-white">
            info@jtutors.com
          </a>
        </p>
      </div>
