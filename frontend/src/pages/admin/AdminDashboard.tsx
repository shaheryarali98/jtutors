                      ...
                      {filteredUsers.map((user) => {
                        ...
                        <tr key={user.id} className="hover:bg-slate-50/60">
                          <td className="px-4 py-3">
                              ...
                              {user.tutor?.verificationRequested && (
                                <div className="mt-2 inline-flex items-center rounded-full bg-amber-50 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-amber-700 border border-amber-200">
          ...
          {tutor && (
            <>
              ...
              />
                <StatusBadge
                  label="Request"
                  status={tutor.verificationRequested ? 'Verification requested' : 'No request'}
                  color={tutor.verificationRequested ? 'amber' : 'slate'}
                />
                <StatusBadge
                  label="Verified"
