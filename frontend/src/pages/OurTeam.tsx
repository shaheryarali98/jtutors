            ...
            {founders.map((founder, index) => (
              ...
              >
                <div className="grid gap-0 md:grid-cols-[220px,1fr]">
                  <div className="relative min-h-[280px] bg-slate-100 md:min-h-full">
                    <img
                      src={founder.image}
                      alt={founder.name}
                      className={`h-full w-full object-cover ${index === 1 ? 'object-top' : 'object-center'}`}
                    />
                  </div>
                  <div className="p-8 sm:p-10">
                    ...
                    <h2 className="mt-5 text-3xl font-black text-slate-900">{founder.name}</h2>
                    <div className="mt-6 h-1 w-16 rounded-full bg-[#f5a11a]" />
                    <p className="mt-6 text-base leading-8 text-slate-700">{founder.bio}</p>
                  </div>
                </div>
              </article>
            ))}
