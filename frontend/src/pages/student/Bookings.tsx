            ...
            {sortedBookings.map((booking) => {
              ...
              return (
                <div key={booking.id} className="bg-white rounded-3xl shadow p-6">
                  ...
                  {(booking.classSession?.googleClassroomLink || booking.classSession?.googleMeetLink) && (
                    <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                      <p className="text-sm font-semibold text-blue-900 mb-3">Join Your Class</p>
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        {booking.classSession.googleMeetLink && (
                          ...
                          >
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                              <path d="M19.36 9.18c.04.32.07.64.07.97 0 1.11-.16 2.18-.46 3.16-.62 1.73-1.54 3.24-2.67 4.5-.28.31-.58.6-.89.87l-.01-.01-.02.01c-1.28 1.1-2.78 1.94-4.38 2.48-.18.06-.37.12-.56.17-.4.11-.81.2-1.23.26h-.02c-.21.03-.42.05-.64.07-.11.01-.22.02-.33.02-.44 0-.88-.04-1.31-.1-.18-.03-.35-.06-.52-.1-.33-.07-.66-.16-.98-.26-.1-.03-.2-.07-.3-.1-1.6-.54-3.1-1.38-4.38-2.48l-.02-.01-.01.01c-.31-.27-.61-.56-.89-.87-1.13-1.26-2.05-2.77-2.67-4.5-.3-.98-.46-2.05-.46-3.16 0-.33.03-.65.07-.97H0c0 1.52.36 2.98 1.02 4.3 1.22 2.52 3.18 4.61 5.56 6.11.47.3.96.58 1.47.82.1.05.2.09.3.13.4.16.81.3 1.23.41.1.03.2.06.3.09.33.1.67.18 1.01.25.18.04.36.07.54.09.36.05.73.08 1.1.1.19.01.38.02.57.02.19 0 .38-.01.57-.02.37-.02.74-.05 1.1-.1.18-.02.36-.05.54-.09.34-.07.68-.15 1.01-.25.1-.03.2-.06.3-.09.42-.11.83-.25 1.23-.41.1-.04.2-.08.3-.13.51-.24 1-.52 1.47-.82 2.38-1.5 4.34-3.59 5.56-6.11.66-1.32 1.02-2.78 1.02-4.3h-1.64z"/>
                              <path d="M12 0C8.12 0 4.6 1.64 2.35 4.29l1.45 1.45C5.78 3.48 8.75 2.14 12 2.14s6.22 1.34 8.2 3.6l1.45-1.45C19.4 1.64 15.88 0 12 0z"/>
                              <path d="M12 4.29c-2.34 0-4.45.9-6.04 2.37l1.45 1.45C8.27 6.98 10.05 6.14 12 6.14s3.73.84 4.59 1.97l1.45-1.45C16.45 5.19 14.34 4.29 12 4.29z"/>
                            </svg>
                            Join Google Meet
                          </a>
                        )}
