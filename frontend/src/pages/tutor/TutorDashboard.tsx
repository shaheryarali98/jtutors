  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#012c4f' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-white mb-8">Tutor Dashboard</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="card">
            ...
            <h3 className="text-xl font-bold mb-2 text-slate-900">My Sessions</h3>
            <p className="text-slate-700 mb-4">View and manage your upcoming tutoring sessions</p>
          ...
          <div className="card">
            <div className="text-4xl mb-4">👤</div>
            <h3 className="text-xl font-bold mb-2 text-slate-900">My Profile</h3>
            <p className="text-slate-700 mb-4">Update your personal information and qualifications</p>
          ...
          <div className="card">
            <div className="text-4xl mb-4">💰</div>
            <h3 className="text-xl font-bold mb-2 text-slate-900">Earnings</h3>
            <p className="text-slate-700 mb-4">Track your earnings and payment history</p>
